...
var sequelize = new Sequelize('d8vt7e4vq932sg', 'mlsojxbqserjnb', '0509a40d74548adc8409df25a2eba1a834f45104e7605fea05bdabaccbda2a85', {
...
exports.updateDepartment = (departmentData) => {
    return new Promise((resolve, reject) => {
        ...
        sequelize.sync()
            .then(Department.update(departmentData, {
                where: {
